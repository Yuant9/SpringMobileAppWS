...
import com.spring.app.ws.model.request.UserSigninRequest;
...
public Authentication attemptAuthentication(HttpServletRequest req,HttpServletResponse res)
		...
		try {
			...
			.readValue(req.getInputStream(),UserSigninRequest.class);
...
protected void successfulAuthentication(HttpServletRequest req,
	...
	//NOTE:  the bean name is"userServiceImp" instead of "UserServiceImp" because spring framework will create a bean with first letter lower-cased
